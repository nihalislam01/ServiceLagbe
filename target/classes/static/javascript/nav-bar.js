...
var searchBar = document.getElementById("click-search");
var workersList = document.querySelector(".workers");
...
searchBar.addEventListener("click", function() {
    if (workersList.style.display === "block") {
...
window.addEventListener("click", function(event) {
    ...
    if (!event.target.matches("#click-search")) {
        workersList.style.display = "none";
    }
});